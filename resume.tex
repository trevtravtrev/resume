  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Progressed from contract (via ESG Automotive) to direct in just 10 months, quickly earning Level 6, Level 7, and Level 7 HTHD promotions due to exceptional performance.}
        \resumeItem{Generated over 60\% cost and development time reduction via architecture modularity and optimization.}
        \resumeItem{Earned 3 Henry Ford Awards, Henry Ford Technology of the Year Runner-Up, and pending patent for outstanding AV contributions.}
      \resumeItemListEnd
