...
\begin{center}
    {\Huge \scshape Trevor White} \\ \vspace{1pt}
    \href{http://www.TrevorAllenWhite.com}{\raisebox{-0.2\height}\faLink\ \underline{trevorallenwhite.com}} \\ \vspace{2pt}
    \small \raisebox{-0.1\height}\faPhone\ 734-552-3120 ~ \href{mailto:me@trevorallenwhite.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{me@trevorallenwhite.com}} ~ 
    \href{https://linkedin.com/in/trevorallenwhite/}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/trevorallenwhite}}  ~
    \href{https://github.com/trevtravtrev}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/trevtravtrev}}
    \vspace{-8pt}
\end{center}
